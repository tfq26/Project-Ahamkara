...
# TASK-20260704-1200-character-animation-runtime

## Goal

Drive rendered characters from the animation runtime with blending, additive layers, IK, and aim/recoil hooks.
...
- character animation runtime wiring
- blend/additive layer playback
...
- Rendered characters consume the animation runtime explicitly.
- Presentation stays separated from combat rules.

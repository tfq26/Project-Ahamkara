...
# TASK-20260704-1130-connection-lifecycle-reliability

## Goal

Harden connection setup/teardown, ack/resend handling, and jitter buffering so network lifecycle behavior is predictable.
...
- renderer changes
- service/matchmaking orchestration
...
- Ack/resend and jitter handling are no longer ad hoc.

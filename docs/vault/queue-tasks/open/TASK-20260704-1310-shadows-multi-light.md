...
# TASK-20260704-1310-shadows-multi-light

## Goal

Expand the renderer from one directional light toward a shadowed multi-light path without reintroducing legacy GL ownership.
...
- shadowed light expansion
- multi-light routing
- modern renderer path only
...
- HDR/offscreen render targets unless explicitly reactivated
- gameplay rule changes
- streaming/world-scale refactors
...
- The new lighting path stays on the modern renderer seam.
- Legacy compatibility ownership is not reintroduced.

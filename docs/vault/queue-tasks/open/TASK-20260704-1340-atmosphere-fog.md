...
# TASK-20260704-1340-atmosphere-fog

## Goal

Add skybox, atmosphere, time-of-day, and height fog behavior so outdoor spaces gain legibility and depth.
...
- time-of-day and height fog
- outdoor legibility tuning
...
- Atmosphere/fog behavior is explicit and tunable.
- The task stays on the modern renderer path.

...
# TASK-20260704-1330-ao-anti-aliasing

## Goal

Add ambient occlusion and an anti-aliasing path that improves readability without changing gameplay ownership.
...
- SSAO/GTAO path
- AA / motion-vector readiness
- color-grading hooks where needed
...
- AO/AA behavior is wired through the modern renderer.
- The slice does not regress existing render behavior.

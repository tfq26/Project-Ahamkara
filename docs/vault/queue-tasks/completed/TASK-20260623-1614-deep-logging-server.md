...
subsystems:
  - server
related_feature:
report: reports/subagents/TASK-20260623-1614-deep-logging-server-report.md
review: ../../../reports/subagents/TASK-20260623-1614-deep-logging-server-codex-review.md
---
...
Standard: report, master log, status/`report: reports/subagents/TASK-20260623-1614-deep-logging-server-report.md`, move to `completed/`.

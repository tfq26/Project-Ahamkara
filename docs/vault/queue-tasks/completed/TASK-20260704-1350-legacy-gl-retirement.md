...
- HDR activation
- gameplay changes
- streaming or network work

## Likely Files

  - `engine/render/src/gl_compat.cpp`
  - `engine/render/include/ae/render/gl_compat.h`
...
- Legacy compatibility is reduced or removed where safe.
- The core-profile path remains the source of truth.

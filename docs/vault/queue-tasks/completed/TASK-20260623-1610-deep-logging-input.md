...
subsystems:
  - engine/input
related_feature:
report: reports/subagents/TASK-20260623-1610-deep-logging-input-report.md
review: ../../../reports/subagents/TASK-20260623-1610-deep-logging-input-codex-review.md
---
...
Standard: report, master log, status/`report: reports/subagents/TASK-20260623-1610-deep-logging-input-report.md`, move to `completed/`.

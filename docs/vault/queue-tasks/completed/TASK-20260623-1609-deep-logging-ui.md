...
subsystems:
  - engine/ui
related_feature:
report: reports/subagents/TASK-20260623-1609-deep-logging-ui-report.md
review: ../../../reports/subagents/TASK-20260623-1609-deep-logging-ui-codex-review.md
---
...
Standard: report, master log, status/`report: reports/subagents/TASK-20260623-1609-deep-logging-ui-report.md`, move to `completed/`.

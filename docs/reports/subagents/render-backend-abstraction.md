...
- `docs/systems/renderer_backend.md` — **New.** Architecture documentation: interface overview, handle design, what-is-not-in-backend table, how-to-add-new-backend guide, public API changes table.
...
- The new `docs/systems/renderer_backend.md` should be linked from `docs/systems/architecture.md` in the renderer section.

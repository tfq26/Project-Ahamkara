...
- `docs/systems/audio_architecture.md` — **New.** Full audio architecture document covering all 10 focus areas (81–90)
- `docs/systems/architecture.md` — Added companion documents section; added "Partial Implementation" note for audio events under Event Bus section
- `docs/systems/client_config.md` — Added audio config keys table + updated example config

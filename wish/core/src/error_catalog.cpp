...
const ErrorCatalogEntry ErrorCatalog::kEntries_[] = {
    ...
    {
        WishDomain::kPersist,
        "errors.persistence.permission_denied",
        "Permission denied",
        "wish/persistence",
    ...
    {
        WishDomain::kPersist,
        "errors.persistence.quota_exceeded",
    ...
    {
        WishDomain::kPersist,
        "errors.persistence.payload_too_large",
    ...
    {
        WishDomain::kPersist,
        "errors.persistence.malformed_payload",
        "Malformed document payload",
        "wish/persistence",
        WishErrorCode::kPersistenceMalformedPayload,
        RecoveryPolicy::None,
        true,
    },
    {
        WishDomain::kPersist,
        "errors.persistence.backend_unavailable",
